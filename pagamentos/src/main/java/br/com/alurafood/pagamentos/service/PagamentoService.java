...
public class PagamentoService {
    ...
    public void confirmarPagamento(Long id) {
        ...
        pedido.atualizaPagamento(pagamento.get().getPedidoId()); // lança uma FeignException que será lidada pelo Resilience4J
        System.out.println("CIRCUIT_BREAKER-2"); // isso não vai ser executado se o pedidoClient falhar
    }
